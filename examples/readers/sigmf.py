"""SigMF catalog descriptions and a reusable Files reader."""
...
from sigvue import DataResource, Files

from ..catalog import SIGNAL_DISCOVERY_COLUMNS
from ..formats.sigmf import SigMFRecording, load_metadata, load_sigmf_recording
...
def sigmf_reader(
    ...
    *,
    ...
    tags: Iterable[str] = ("sigmf",),
) -> Files[SigMFRecording]:
    """Create a reusable SigMF reader with exact record loading."""
