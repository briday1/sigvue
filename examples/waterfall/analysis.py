"""Numerical waterfall processing with no browser or styling decisions."""

import numpy as np

from ..formats.sigmf import SigMFWindow
...
def analyze(
    ...
    """Run the same exact analysis headlessly or through Sigvue."""
    if settings.fft_size < 1:
