"""Recover symbol samples and eye traces from one selected recording window."""
...
def analyze(window: SigMFWindow) -> CommsProducts:
    """Run the pipeline directly from a script, test, notebook, or Sigvue."""
